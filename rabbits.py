...
"""Solution to the Rabbits and Recurrence Relations problem in the 
Bioinformatics Stronghold section of Rosalind
location: http://rosalind.info/problems/fib/
Problem: given two intergers n and k, return the total number of rabbit pairs
present after n months where each pair produces a litter of k pairs
"""
